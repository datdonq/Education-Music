...
# Yêu cầu thị giác và chuyển động (cho hệ sinh video)
- prompt_image: mô tả khung hình đầu của cảnh (bằng tiếng Anh), rõ ràng, không chứa hội thoại.
- prompt_video: mô tả chuyển động/video (bằng tiếng Anh), không chứa hội thoại/âm thanh; dùng thì hiện tại tiếp diễn, mô tả 1-2 hành động mượt, camera đơn giản (ví dụ: slight pan/slow zoom), ánh sáng rõ, màu sắc tươi sáng cho thiếu nhi, nhất định không được mô tả ngoại hình của nhân vật mà chỉ dùng :character
- Không yêu cầu text xuất hiện trong cảnh; giữ hậu cảnh gọn gàng, phù hợp chủ đề học tập.
- Tỉ lệ khung hình 16:9, phong cách hoạt hình/đáng yêu phù hợp trẻ em.
